...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, X_train_smote_path, X_test_smote_path, y_train_smote_path, y_test_smote_path):
        try:
            ...
            "Logistic Regression": {
                'C': [0.1, 1.0, 10.0],  # Regularization parameter
                    ...
                    'max_iter': [10, 20, 30],  # Maximum number of iterations
            ...
            balanced_accuracy_score = balanced_accuracy_score(y_test, predicted)
